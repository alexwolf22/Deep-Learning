...
% EXP DIR defines where the snapshots of your model are stored
opts.expDir = '/Users/alexwolf/desktop/cs78/hw2/results/baseModel';
...
opts.database_path = 'database-base-categorization.mat';
...
switch opts.modelType    
    case 'advanced'
        ...
        % - - - - - - - - - - - - - - - - - - - - - - - - - -
        % Specify the struct netspec_opts for the advanced model HERE

        % Specify the struct train_opts for the advanced model HERE

        % - - - - - - - - - - - - - - - - - - - - - - - - - -

        %net = cnn_categorization_advanced(netspec_opts, train_opts, database.meta.classes) ;
    case 'base'
